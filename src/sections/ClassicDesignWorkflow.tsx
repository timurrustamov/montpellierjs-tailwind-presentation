...
const ClassicDesignWorkflow: FunctionComponent = () => {
  return (
    <Section
      ...
      <h2 className="flex items-center justify-center py-12 text-5xl text-gray-100 whitespace-pre drop-shadow-md">
        <span className="text-red-400">Classic Design</span> Workflow
      </h2>

      <div className="flex items-center justify-center row-span-2">
        <StaticImage
          className="w-full max-w-screen-md drop-shadow-2xl"
          src="../images/classic-design-workflow.png"
...
export default ClassicDesignWorkflow;
